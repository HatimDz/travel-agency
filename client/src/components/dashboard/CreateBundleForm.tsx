  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Create New Bundle</h2>
          <p className="text-muted-foreground">Add a new travel bundle to your inventory</p>
        </div>
        <Button
          variant="outline"
      ...
      <Card className="border-none shadow-md overflow-hidden bg-white dark:bg-gray-800">
        <CardHeader className="border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
          ...
          <CardDescription>Enter the details of your new bundle</CardDescription>
        </CardHeader>
